@testset "vcatsort" begin
    @testset "Forward Forward" begin
        for (x, y, ret, cmp) in (([1, 2, 3], [4, 5, 6], [1, 2, 3, 4, 5, 6], "< < gap"),
            ...
            @testset "$cmp" begin
                @test @inferred(SortedArrays._vcatsort(Forward, Forward, x, y)) == ret
            end
        end
    end
    ...
    @testset "Forward Reverse" begin
        for (x, y, ret, cmp) in (([1, 2, 3], [6, 5, 4], [1, 2, 3, 4, 5, 6], "< < gap"),
            ...
            @testset "$cmp" begin
                @test @inferred(SortedArrays._vcatsort(Forward, Reverse, x, y)) == ret
            end
        end
    end
    ...
    @testset "Reverse Forward" begin
        for (x, y, ret, cmp) in (([3, 2, 1], [4, 5, 6], [6, 5, 4, 3, 2, 1], "< < gap"),
            ...
            @testset "$cmp" begin
                @test @inferred(SortedArrays._vcatsort(Reverse, Forward, x, y)) == ret
            end
        end
    end
    ...
    @testset "Reverse Reverse" begin
        for (x, y, ret, cmp) in (([3, 2, 1], [6, 5, 4], [6, 5, 4, 3, 2, 1], "< < gap"),
            ...
            @testset "$cmp" begin
                @test @inferred(SortedArrays._vcatsort(Reverse, Reverse, x, y)) == ret
            end
        end
    end
end
