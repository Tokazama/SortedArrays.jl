#=
Catani et al 2012 aslan path
Chernoff sims, pilcher, mahon, 2019 cognitive neurospychology
openbrainproject.org
brainlab
probability that a patient will have problems if you ressect this spot
=#
#using SortedArrays: index_orders

@testset "vcatsort" begin
    for (xo, yo, x, y, ret, cmp) in ((Forward, Forward, [1, 2, 3], [4, 5, 6], [1, 2, 3, 4, 5, 6], "< < gap"),
                                     (Forward, Forward, [1, 2, 3], [2, 3, 4], [1, 2, 2, 3, 3, 4], "< <"),
                                     ...
                                     (Forward, Reverse, [4, 5, 6], [3, 2, 1], [1, 2, 3, 4, 5, 6], "> > gap"),
                                     ...
                                     (Reverse, Forward, [6, 5, 4], [1, 2, 3], [6, 5, 4, 3, 2, 1], "> > gap"),
                                     ...
                                     (Reverse, Reverse, [6, 5, 4], [3, 2, 1], [6, 5, 4, 3, 2, 1], "> > gap"),
        ...
        @testset "$xo-$yo-$cmp" begin
            @test @inferred(SortedArrays._vcatsort(xo, yo, x, y)) == ret
        end
    end
end
